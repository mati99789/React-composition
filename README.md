# React composition simple meeting information
This time we will use the React library to build a simple database storing information about the date of the meeting with a 
specific person (we collect the date, time, name, surname and email via the form).
This is a basic react calendar meeting information with basic style.
...
Plan more before starting code.</br>
Add more style.
